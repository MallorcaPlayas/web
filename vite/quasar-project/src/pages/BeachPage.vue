...
<template>
  <div class="q-pa-md">
    ...
    <q-btn
      color="negative"
      icon="delete"
      :label="`Eliminar Playas seleccionadas`"
...
onMounted(async () => {
  beaches.value = await beachService.getAll();
  rows.value = generateRows(beaches.value);
})
